...
#生成CT的地对空导弹
execute as @a[team=CT,advancements={djzc666:tool/missile_sam=true}] at @s run summon minecraft:snowball ~ ~1 ~ {Tags:["CT_GA","GF_AA","AA","missile"],PortalCooldown:120,NoGravity:true}
#登记发射者
