...
execute as @a[x=-306,y=63,z=-857,dx=23,dy=7,dz=4,team=T] at @s run scoreboard players add @s djzc.occupy 1

function djzc444:game/game_flow
#运行游戏流程计算器

tellraw @a {translate:"djzc.msg.a_occupy_by_t",fallback:"A点已被T阵营占领!",color:"green"}
#友情提示
