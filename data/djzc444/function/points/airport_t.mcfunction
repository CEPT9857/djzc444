...
execute if score @s[team=T,tag=AF] djzc.airport_t <= 0 djzc.time3 at @s run function djzc444:weapon/missile_aa
execute if score @s[team=T,tag=AF] djzc.airport_t <= 0 djzc.time3 at @s run function djzc444:weapon/missile_ag
