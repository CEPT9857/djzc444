...
#音效
execute if score C1 gameflow matches 1 run tellraw @a {translate:"djzc.msg.starter_c1.no_again",fallback:"C1已被激活，请勿重复激活启动器!",color:"green"}
execute if score C1 gameflow matches 0 run tellraw @a {translate:"djzc.msg.starter_c1",fallback:"启动器[C1]被激活!",color:"green"}
#友情提示
