...
#音效
execute if score D1 gameflow matches 1 run tellraw @a {translate:"djzc.msg.starter_d1.no_again",fallback:"D1已被激活，请勿重复激活启动器!",color:"green"}
execute if score D1 gameflow matches 0 run tellraw @a {translate:"djzc.msg.starter_d1",fallback:"启动器[D1]被激活!",color:"green"}
#友情提示
