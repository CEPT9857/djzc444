...
execute if score T_SD time3 <= 0 time3 run scoreboard players set T_SD time3 60
#引用占点函数
...
#超过1040时进位
execute if score T_SD time3 > 60 time3 run scoreboard players set T_SD time3 60
#超过30时限制最大值
