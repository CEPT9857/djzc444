...
execute if score @s[team=CT,tag=AF] djzc.airport_ct <= 0 djzc.time3 at @s run function djzc444:weapon/missile_aa
execute if score @s[team=CT,tag=AF] djzc.airport_ct <= 0 djzc.time3 at @s run function djzc444:weapon/missile_ag
