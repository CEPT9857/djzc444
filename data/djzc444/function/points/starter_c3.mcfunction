...
#音效
execute if score C3 gameflow matches 1 run tellraw @a {translate:"djzc.msg.starter_c3.no_again",fallback:"C3已被激活，请勿重复激活启动器!",color:"green"}
execute if score C3 gameflow matches 0 run tellraw @a {translate:"djzc.msg.starter_c3",fallback:"启动器[C3]被激活!",color:"green"}
#友情提示
