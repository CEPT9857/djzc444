...
#音效
execute if score C2 gameflow matches 1 run tellraw @a {text:"C2已被激活，请勿重复激活启动器!",color:"green"}
execute if score C2 gameflow matches 0 run tellraw @a {text:"启动器[C2]被激活!",color:"green"}
#友情提示
