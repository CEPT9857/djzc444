...
#音效
execute if score D2 gameflow matches 1 run tellraw @a {translate:"djzc.msg.starter_d2.no_again",fallback:"D2已被激活，请勿重复激活启动器!",color:"green"}
execute if score D2 gameflow matches 0 run tellraw @a {translate:"djzc.msg.starter_d2",fallback:"启动器[D2]被激活!",color:"green"}
#友情提示
