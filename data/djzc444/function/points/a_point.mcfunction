...
execute store result bossbar minecraft:a value run scoreboard players get T_SA djzc.time3
#存储占点分数到bossbar
...
#显示bossbar
execute if score T_SA djzc.time3 <= 15 djzc.time3 run bossbar set minecraft:a color red
execute if score T_SA djzc.time3 > 15 djzc.time3 run bossbar set minecraft:a color blue
#改bossbar颜色
