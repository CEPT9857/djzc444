...
execute as @a at @s if score @s djzc.option matches 8 run function djzc444:option/scoreboard_prepare
...
execute as @a at @s if score @s djzc.option matches 13 run function djzc444:option/do_stop_music
execute as @a at @s if score @s djzc.option matches 14 run function djzc444:option/do_kill
