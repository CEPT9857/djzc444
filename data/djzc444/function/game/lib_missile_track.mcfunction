...
#删除动量
execute as @e[type=minecraft:firework_rocket,tag=AA] at @s facing entity @e[type=minecraft:item,sort=nearest] feet run tp ^ ^ ^1.4

execute as @e[type=minecraft:firework_rocket,tag=AG] at @s facing entity @e[type=minecraft:item,sort=furthest] feet run tp ^ ^ ^1.5
#干扰
execute as @e[type=minecraft:firework_rocket,tag=CT_AA] at @s facing entity @e[team=T,tag=AF,sort=nearest] feet run tp ^ ^ ^1.5
execute as @e[type=minecraft:firework_rocket,tag=T_AA] at @s facing entity @e[team=CT,tag=AF,sort=nearest] feet run tp ^ ^ ^1.5
#追踪敌人（空对空导弹，地对空导弹）
execute as @e[type=minecraft:firework_rocket,tag=CT_AG] at @s facing entity @a[team=T,tag=GF,sort=nearest] feet run tp ^ ^1 ^1.5
execute as @e[type=minecraft:firework_rocket,tag=T_AG] at @s facing entity @a[team=CT,tag=GF,sort=nearest] feet run tp ^ ^1 ^1.5
#追踪敌人（空对地导弹）
