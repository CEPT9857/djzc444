...
scoreboard players set 60 time3 60
...
scoreboard players set T_SB time3 60
scoreboard players set T_B time3 1040
scoreboard players set T_SC time3 60
scoreboard players set T_C time3 1040
scoreboard players set T_SD time3 60
scoreboard players set T_D time3 1040
#占点时间重置